      ...
      >
        ...
        <View style={{ padding: 10 }}>
          ...
          <View>
            ...
            >
              <Text style={{ fontFamily: "CairoBold", fontSize: 13 }}>
                السعر :
              </Text>
              <View
                style={{
              ...
              >
                <Text style={{ color: "#55a8b9", fontFamily: "CairoMed" }}>
        ...
        <View style={{ ...styles.feature, backgroundColor: "#F0F9FF" }}>
          ...
          >
            لست بحاجة لمعرفة العنوان (فريقنا سيفعل ذلك نيابة عنك)
          </Text>
        </View>
        ...
        {reviews && reviews.length > 0 ? (
          ...
          >
            <View style={styles.revHeader}>
              ...
              />
              <Text
                style={{ fontSize: 14, color: "#fff", fontFamily: "CairoMed" }}
              >
                تقيمات عملائنا:
              </Text>
            </View>
          ...
          <>
            <View style={styles.revHeader}>
              <MaterialIcons
                ...
                style={{ marginHorizontal: 10 }}
              />
              <Text style={{ fontFamily: "CairoBold", fontSize: 14 }}>
                تقيمات عملائنا:
              </Text>
            </View>
