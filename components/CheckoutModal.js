      ...
      <View style={styles.container}>
        <View style={styles.wrapper}>
          <View style={styles.header}>
            <Text style={styles.title}>اختر وسيلة الدفع</Text>
          </View>
          ...
          {method === "TRANSFER" && (
            <View style={styles.bankInfoContainer}>
              ...
              >
                اسم المصرف : <Text style={styles.boldText}>مصرف الراجحي</Text>
              </Text>
              <Text
                style={{
                  fontFamily: "CairoMed",
              ...
              >
                اسم المالك : <Text style={styles.boldText}>TRENDY ROSE</Text>
              </Text>
              <Text
                style={{
                  fontFamily: "CairoMed",
              ...
              >
                السويفت : <Text style={styles.boldText}>RJHISARI</Text>
              </Text>
            </View>
          )}
          <View style={styles.bankInfoContainer}>
            ...
            >
              سياسة الإستبدال والإسترجاع: يحق للعميل الاستبدال قبل البدء بتجهيز
              المنتج ، لكن بعد خروج الطلب للتوصيل لا يمكن الاستبدال أو الاسترجاع
              وفقاً لطبيعة المنتج و الخدمة المقدمة. في حال وجود خلل أو تلف بعد
              التوصيل فيحق للعميل انطلاقاً من مبدأ الثقة المتبادلة إستبدال
              المنتج او الحصول على كامل القيمه المدفوعه. آلية ارجاع المبالغ: يتم
              ارجاع المبلغ بنفس طريقة الدفع التي تمت .
            </Text>
          </View>
          <View style={styles.noteSection}>
            <Text style={styles.noteSectionText}>
              بالضغط على اختيار "ادفع الاّن" فأنت توافق على
            </Text>
