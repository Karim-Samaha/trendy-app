    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={{
            ...styles.input,
            backgroundColor: storeDeleviryData.valid ? "silver" : "#fff",
          }}
          placeholder="الاسم بالكامل"
          value={storeDeleviryData.name}
        ...
        {errors.name && (
          <Text style={styles.error}>
            {storeDeleviryLocale["ar"].nameError}
          </Text>
        )}
      </View>
      <View style={styles.inputContainer}>
        ...
        {errors.phone && (
          <Text style={styles.error}>
            {storeDeleviryLocale["ar"].phoneError}
          </Text>
        )}
      </View>
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          placeholder="تاريخ الاستلام من المتجر"
          editable={!storeDeleviryData.valid}
      ...
      {storeDeleviryData.valid && (
        <Pressable
          style={styles.button}
          onPress={() =>
            setStoreDeleviryData((prev) => ({ ...prev, valid: false }))
          }
        >
          <Text style={{ color: "#fff", fontFamily: "CairoMed" }}>
            {storeDeleviryLocale["ar"].edit}
          </Text>
        </Pressable>
      )}
      {isDatePickerVisible && (
